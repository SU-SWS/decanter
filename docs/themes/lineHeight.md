...
The line height theme plugin defines Stanford's optimized line height scale designed for maximum readability across different text sizes and contexts. It replaces Tailwind's default line heights with values specifically calibrated for Stanford's typography system and provides specialized line heights for unique Stanford design requirements.
