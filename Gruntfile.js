      ...
      default: {
        ...
        options: {
          ...
          groups: {
            ...
            '_variables|grid-media': 'Variables: Neat Grids',
            '_variables|buttons': 'Variables: Buttons',
            '_variables|colors': 'Variables: Colors',
            '_variables|containers': 'Variables: Containers',
            '_variables|forms': 'Variables: Forms',
            '_variables|typography': 'Variables: Typography',
            '_variables|vertical-rhythm': 'Variables: Vertical Rhythm',
            'font-management': 'Font Loading & Management',
            'functions': 'Functions',
            'mixins': 'Mixins',
            'base|_documentation': 'Base: Documentation',
            'base|box-model': 'Base: Box Model',
            'base|body': 'Base: Body',
            'base|typography': 'Base: Typography',
            'base|forms': 'Base: Forms',
            'base|lists': 'Base: Lists',
            'base|tables': 'Base: Tables',
            'base|media-elements': 'Base: Media Elements',
