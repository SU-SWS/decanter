...
class EventHandlerDispatch {
  ...
  onKeydown(event, target) {
    ...
    let normalized = Object(_utilities_keyboard__WEBPACK_IMPORTED_MODULE_0__["normalizeKey"])(theKey);
...
class SecondaryNavAccordion extends _common_SecondaryNavAbstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  newParentItem(item, depth, parent) {
    ...
    var nav = new _SecondarySubNavAccordion__WEBPACK_IMPORTED_MODULE_2__["default"](
      item,
      this,
      parent,
      opts
  ...
  newNavItem(item, depth, parent) {
    ...
    var nav = new _common_SecondaryNavItem__WEBPACK_IMPORTED_MODULE_1__["default"](
      item,
      this,
      parent,
      opts
...
class SecondaryNavButtons extends _common_SecondaryNavAbstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
   ...
   */
  newParentItem(item, depth, parent) {
    var nav = new _SecondarySubNavButtons__WEBPACK_IMPORTED_MODULE_2__["default"](
      item,
      this,
      parent,
      {
