    ...
    value: function createNavItems() {
      ...
      items.forEach(function (item) {
        ...
        if (item.querySelector(item.tagName + ' > ul')) {
          _this.subNavItems.push(new _SubNavItem__WEBPACK_IMPORTED_MODULE_2__["default"](item, _this, _this.options));
        } // NavItems have specific event handling.
        else {
            _this.navItems.push(new _NavItem__WEBPACK_IMPORTED_MODULE_1__["default"](item, _this, _this.options));
          }
      });
    }
    /**
...
/* harmony import */ var _main_nav_NavItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../main-nav/NavItem */ "./core/src/js/components/main-nav/NavItem.js");
/* harmony import */ var _main_nav_Nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../main-nav/Nav */ "./core/src/js/components/main-nav/Nav.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Nav) {
  ...
  _createClass(ToggleNav, [{
    ...
    value: function createNavItems() {
      ...
      items.forEach(function (item) {
        // Subnav items have special behaviour.
        if (item.querySelector(item.tagName + ' > ul')) {
          _this.subNavItems.push(new _ToggleSubNavItem__WEBPACK_IMPORTED_MODULE_1__["default"](item, _this, _this.options));
        } // NavItems have specific event handling.
        else {
            _this.navItems.push(new _ToggleNavItem__WEBPACK_IMPORTED_MODULE_0__["default"](item, _this, _this.options));
          }
      });
    }
    /**
  ...
  return ToggleNav;
}(_main_nav_Nav__WEBPACK_IMPORTED_MODULE_3__["default"]);
